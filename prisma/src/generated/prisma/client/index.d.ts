...
export namespace Prisma {
  ...
  */
    ...
    model: {
      WatchlistItem: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.WatchlistItemFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.WatchlistItemAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type WatchlistItemOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "movieId" | "title" | "posterPath" | "voteAverage" | "releaseDate" | "overview" | "userId" | "addedAt", ExtArgs["result"]["watchlistItem"]>
  ...
  export interface WatchlistItemDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more WatchlistItems that matches the filter.
     * @param {WatchlistItemFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const watchlistItem = await prisma.watchlistItem.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: WatchlistItemFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a WatchlistItem.
     * @param {WatchlistItemAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const watchlistItem = await prisma.watchlistItem.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: WatchlistItemAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface WatchlistItemFieldRefs {
    ...
    readonly voteAverage: FieldRef<"WatchlistItem", 'Float'>
    readonly releaseDate: FieldRef<"WatchlistItem", 'String'>
  ...
  /**
   * WatchlistItem findRaw
   */
  export type WatchlistItemFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * WatchlistItem aggregateRaw
   */
  export type WatchlistItemAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type WatchlistItemWhereInput = {
    ...
    posterPath?: StringFilter<"WatchlistItem"> | string
    voteAverage?: FloatFilter<"WatchlistItem"> | number
    releaseDate?: StringFilter<"WatchlistItem"> | string
  ...
  export type WatchlistItemScalarWhereWithAggregatesInput = {
    ...
    posterPath?: StringWithAggregatesFilter<"WatchlistItem"> | string
    voteAverage?: FloatWithAggregatesFilter<"WatchlistItem"> | number
    releaseDate?: StringWithAggregatesFilter<"WatchlistItem"> | string
  ...
  export type WatchlistItemUpdateInput = {
    ...
    posterPath?: StringFieldUpdateOperationsInput | string
